// app/api/extract-profile/route.ts - HARDCODED TEST (FINAL)
import { NextResponse } from 'next/server';
import OpenAI from 'openai';

export const runtime = 'nodejs';

const HARDCODED_API_KEY = "sk-or-v1-dc545db75818e6a616b790e407f3e45a07d7714e1443bdee3330da4dc9ee5f"; // Replace XXXX with actual key
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const client = new OpenAI({
      ...
      defaultHeaders: {
        "HTTP-Referer": "https://career-pilot-ai-final.vercel.app",
